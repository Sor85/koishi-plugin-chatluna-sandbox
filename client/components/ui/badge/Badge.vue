...
.sandbox-badge[data-variant='secondary'] {
  color: #64748b;
  background: #e2e8f0;
}
...
/* 暗色钩子照仓库统一的两个作用域写（同 tailwind.source.css 里 dark 变体的定义）：宿主控制台
   ...
   任何带 .dark 的元素，又完全丢掉了徽标那一段，暗色配色静默失效。详见 docs/adr/0097。 */
:is([data-color-mode='dark'], body[data-sandbox-color-scheme='dark']) .sandbox-badge[data-variant='secondary'] {
  color: #cbd5e1;
  background: #334155;
}
</style>
