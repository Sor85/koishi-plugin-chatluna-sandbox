...
import { attachWebqqScrollbar, type WebQQScrollbarHandle } from '#client/shared/scrollbar'
import {
  codeMirrorOffset,
...
let scrollbar: WebQQScrollbarHandle | undefined
...
onMounted(() => {
  ...
  scrollbar = attachWebqqScrollbar(view.scrollDOM)
  dispatchDecorations()
