...
import EnvironmentEntityDialog from '#client/environment/entity-dialog.vue'
import WebqqAvatar from '#client/shared/avatar.vue'
import { getFloatingPanelStyle, clampFloatingPanelPosition, isFloatingPanelInteractiveTarget } from '#client/shared/floating-panel'
