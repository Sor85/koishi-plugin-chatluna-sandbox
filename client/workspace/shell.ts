...
import type { SandboxWorkspaceView } from './state'
import type { FriendMenuState } from '#client/webqq/friend-menu'
import { buildConversationTree, toRecentForwardTargets } from '#client/webqq/conversation-tree'
import { buildForwardPreviewMap } from '#client/webqq/forward-preview'
import { buildMessageCapabilityMap } from '#client/webqq/message-capabilities'
...
import type { createWorkspaceController } from './controller'
import type { createWorkspaceLayout } from './layout'
import type {
