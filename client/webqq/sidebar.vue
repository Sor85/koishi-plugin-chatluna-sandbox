...
import EnvironmentCreatePopover from '#client/environment/create-popover.vue'
...
import SandboxAgentControlIcon from '#client/shared/sandbox-agent-control-icon.vue'
import type { ConversationTreeNode } from './conversation-tree'
import { createConversationTreeExpansion } from './conversation-tree-expansion'
import { getGroupRoleLabel } from './group-display'
