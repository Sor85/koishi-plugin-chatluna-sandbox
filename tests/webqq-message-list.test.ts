...
describe('WebQQ 消息列表', () => {
  ...
  it('群消息展示表情回应 chip，并提供贴表情入口', () => {
    ...
    expect(source).toContain("emit('setMessageReaction', messageId, emojiId, true)")
    ...
    expect(reactionsSource).toContain('webqq-message-reaction-count')
