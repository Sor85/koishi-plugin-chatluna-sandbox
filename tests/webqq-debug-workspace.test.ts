...
describe('WebQQ OneBot 调试工作台', () => {
  it('从最左侧导航进入独立视图，并提供筛选、详情和清理控件', () => {
    ...
    expect(shellSource).toContain("if (view === 'debug') void loadOneBotDebugRecords()")
    expect(shellSource).toContain("if (currentView.value === 'debug') await loadOneBotDebugRecords()")
