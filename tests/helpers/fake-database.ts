...
export function createEvidenceRecordDatabase(): FakeDatabase {
  return new FakeDatabase({
    'chatluna-sandbox.debug-record': ['scopeId', 'sequence'],
    'chatluna-sandbox.debug-scope': ['scopeId'],
    'chatluna-sandbox.model-request': ['scopeId', 'sequence'],
    'chatluna-sandbox.model-request-scope': ['scopeId'],
  })
}
