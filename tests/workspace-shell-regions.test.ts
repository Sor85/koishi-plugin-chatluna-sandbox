...
import { createFakeWorkspacePort, type WorkspacePortOperation } from '../client/workspace/fake-port'
import type { TestCallRecordPortOperation } from '../client/test-call/port'
import type { ModelRequestPortOperation } from '../client/model-request/port'
import type { OneBotDebugPortOperation } from '../client/onebot-debug/port'
import type { PresetPortOperation } from '../client/preset/port'
